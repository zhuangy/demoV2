	...
	success:function(res){
		...
		for (i in res){
			...
			//if(parseFloat(date.substr(3,2))>28){
				...
				var admin = [-1,0,1,2,8,11,12,14,15,41,114,130,133,134,144,146,147,150,152,149,155,158,159,147,157,148,153,198,199,202,215,224, 251, 252, 248, 250, 249, 247,236,143, 257, 303, 304, 305, 301, 294, 307, 308, 302, 306, 300, 296, 299, 413, 323, 363, 131];
