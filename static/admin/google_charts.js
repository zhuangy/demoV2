	...
	success:function(res){
		...
		for (i in res){
			...
			//if(parseFloat(date.substr(3,2))>28){
				...
				var admin = [-1,0,1,2,8,11,12,14,15,41,114,130,133,134,144,146,147,150,152,149,155,158,159,147,157,148,153,198,199,202,215,224, 251, 252, 248, 250, 249, 247,236,143, 257];
				...
				date = (parseFloat(date.getMonth())+1) + '/' + date.getDate()+'/'+date.getFullYear();
					...
					total_daily
					var col;
					if(id.indexOf('1111')!=-1){
						//IOTA
						col = 1;
					}
					else if(id.indexOf('1112')!=-1){
						//Lucias
						col = 2;
					}
					//UPDATE COUNT
